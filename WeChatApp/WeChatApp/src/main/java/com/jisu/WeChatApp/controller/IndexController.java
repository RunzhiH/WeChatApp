...
public class IndexController {
	...
	public static void main(String[] args) {
		// 年月日文件夹
		/*
		 * SimpleDateFormat sdf = new SimpleDateFormat("yyyyMMdd"); String basedir =
		 * sdf.format(new Date()); System.out.println(basedir);
		 */
		// å¶ç»§å
		 ...
		 * 
		 * System.out.println("str=="+str); å¯ç±ä½ çç¬ 3ä¸ªè­çè wkkçå¯å¯
		 */
		String uniqueFlag = "";
		try {
			uniqueFlag = new String("çç".getBytes("ISO-8859-1"), "UTF-8");
