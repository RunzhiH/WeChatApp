...
public class AT0009 extends MessageTemplate {
	...
	public void setDataInfo(Map<String, String> messageData) {
		...
		keyword1.setValue(messageData.get("create_time_str"));
		m.put("keyword1", keyword1);
		TemplateData keyword2 = new TemplateData();
		keyword2.setValue(messageData.get("order_code"));
		m.put("keyword2", keyword2);
		TemplateData keyword3 = new TemplateData();
		keyword3.setValue(String.valueOf(messageData.get("pay_price")));
		m.put("keyword3", keyword3);
		TemplateData keyword4 = new TemplateData();
		keyword4.setValue(messageData.get("appointment_time_start_str"));
