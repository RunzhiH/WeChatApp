...
/**
 * @项目名称：wyait-manage
 * @包名：com.wyait-common.utils @类描述：
 * @创建人：wyait @创建时间：2018-01-08 15:36 @version：V1.0
 */
public class ValidateUtil {
	...
	/*
	 * private static final Pattern YOUNG_PASSWORD = Pattern .compile("");
	 */
	...
	/*
	 * public static boolean isYoungPassword(String str) { return str != null &&
	 * YOUNG_PASSWORD.matcher(str).matches(); }
	 */
	 ...
	 *
	 * @描述：微信号校验
	 * @创建人：wyait @创建时间：2016年12月26日17:52:08
	 * @param str
	 * @return
	 */
	...
	public static void main(String[] args) {
		/*
		 * String str = "qwe7891"; String str10 = "qwertyuio@48911111"; String str11 =
		 * "qwertyuio!5678911110"; String str1 = "192.0.10.1"; String str2 =
		 * "192.168.10.05"; String str3 = "192.8.10.50"; String str4 = "256.168.10.255";
		 * String str5 = "666.2.2.3"; String str6 = "255.26.0.0"; String str7 =
		 * "255.25.253.0"; String str8 = "255.26.273.23"; String str9 = "255.25.23.2";
		 */
		String qq = "0.12";
		String qq2 = "1.12";
		String qq3 = "0.123";
		...
		/*
		 * System.out.println(str + ": " + isPassword(str) + "+++长度" + str.length());
		 * System.out.println(str10 + ": " + isPassword(str10) + "+++长度" +
		 * str10.length()); System.out.println(str11 + ": " + isPassword(str11) +
		 * "+++长度" + str11.length()); System.out.println(str1 + ": " + isAddrIP(str1));
		 * System.out.println(str2 + ": " + isAddrIP(str2)); System.out.println(str3 +
		 * ": " + isAddrIP(str3)); System.out.println(str4 + ": " + isAddrIP(str4));
		 * System.out.println(str5 + ": " + isAddrIP(str5)); System.out.println(str6 +
		 * ": " + isAddrIP(str6)); System.out.println(str7 + ": " + isAddrIP(str7));
		 * System.out.println(str8 + ": " + isAddrIP(str8)); System.out.println(str9 +
		 * ": " + isAddrIP(str9));
		 */
		// String str = "我是";
		// String str1 = "王者";
