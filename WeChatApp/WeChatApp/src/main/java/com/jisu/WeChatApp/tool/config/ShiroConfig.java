...
import com.jisu.WeChatApp.tool.realm.ShiroRealm;
import com.jisu.WeChatApp.tool.util.RetryLimitHashedCredentialsMatcher;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilterFactoryBean(org.apache.shiro.mgt.SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/login/updateMmeberPwd", "anon");
	 ...
	 *                                                                                              after
	 *                                                                                              the
	 *                                                                                              lifecycleBeanProcessor(保证实现了Shiro内部lifecycle函数的bean执行)
	 *                                                                                              has
	 *                                                                                              run
	 *                                                                                              </br>
	 *                                                                                              不使用注解的话，可以注释掉这两个配置
