...
import com.jisu.WeChatApp.dao.PermissionMapper;
import com.jisu.WeChatApp.dao.RoleMapper;
import com.jisu.WeChatApp.dao.RolePermissionMapper;
...
import com.jisu.WeChatApp.service.RoleService;
...
public class RoleServiceImpl implements RoleService {
	...
	public String delPermission(String id) {
		...
		List<Permission> childPerm = permissionMapper.findChildPerm(id);
	...
	@Override
	public Role findRoleAndPerms(String id) {
	...
	@Override
	public List<Permission> getUserPerms(String id) {
	...
	private void batchDelRolePerms(String roleId) {
		List<RolePermission> rpks = rolePermissionMapper.findByRole(roleId);
